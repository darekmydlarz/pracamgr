...
a także rodzajach relacji jakie między sobą tworzą.
...
analizę sentymentu wypowiedzi i geolokalizację w celu bogatszego badania
sieci społecznych. Ich zastosowanie otwiera możliwość odkrycia
ciągów przyczynowo-skutkowych w procesie tworzenia się sieci społecznych.

W tym celu zebrane zostało blisko 8 milionów wpisów z serwisu Twitter,
których autorami było ponad 1,5 miliona internautów. Przy ich pomocy
zostały przeprowadzone analizy pokazujące sposoby w jaki można
zastosować sentyment i geolokację w sieciach społecznych uzyskując ciekawe 
rezultaty. Dane, które były zbierane ukierunkowane były na środowisko
...
\textit{proof-of-concept} (ang. potwierdzenie, dowód koncepcji)
