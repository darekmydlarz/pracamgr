...
\end{equation}  
gdzie $E_i$ to zbiór wierzchołków w wydarzeniu $i$. Krótko mówiąc podobieństwo
...
natomiast $E_{V_1 \cap V_2}$ oznacza wszystkie krawędzie między wspólnymi wierzchołkami.

\clearpage
Poniżej przedstawiam wyniki podobieństwa między grafami przedstawionymi na 
rysunku \ref{image:podobienstwo-grafow}.
