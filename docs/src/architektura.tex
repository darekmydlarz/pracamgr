...
\section{Baza danych}
Jak zostało już wspomniane użyta została baza danych PostgreSQL.
Poniżej znajduje się rysunek \ref{image:schemat-bazy} przedstawiający schemat bazy. 
W tych tabelach zostały zapisane wszystkie informacje potrzebne do pobierania
danych z nasłuchiwanych meczów.
