...
W tabeli \ref{table:listameczow} zaprezentujowano listę wszystkich meczów, które
...
pokazujących w jaki sposób można połączyć te trzy dziedziny by odkrywać wiedzę dotyczącą sieci
społecznych. Pokazane jest do czego można użyć sentymentu, do czego geolokacji
