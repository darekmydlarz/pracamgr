...
sentymentu \rref{section:analizasentymentu2}, analizą społeczną 
\rref{section:analizaspoleczna} i analizą geolokacji 
\rref{section:analizageograficzna}.
...
W tabeli \ref{table:listameczow} zaprezentowano listę wszystkich meczów, które
...
\begin{itemize}
  ...
  \rref{subsection:rozkladnamapie},
  
  \item odległość kibiców od miejsca rozgrywania meczu
  \rref{subsection:odlegloscodstadionu},
  
  \item rozkład wpisów z geolokacją
  \rref{subsection:geowpisy}.
\end{itemize}
...
W badaniach skupiono się także na zachowaniu użytkowników z wykorzystaniem 
