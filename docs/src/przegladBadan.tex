...
społecznych, a konkretnie czym ta nauka się zajmuje i w jakich przypadkach może
zostać zastosowana.
Następnie omówiona zostaje analiza sentymentu wypowiedzi i przetwarzanie tekstu
pod kątem tej analizy.
Później skupiam się nad geolokacją, opisem tego co można dzięki niej się
dowiedzieć, a rozdział kończę omówieniem serwisu społecznościowego Twitter,
...
Przykładowy graf \ref{image:closeness} i tabela \ref{tab:closeness} z
...
balansowana celem odkrywania grup -- przedstawiona w
...
przetwarzaniem języka naturalnego, z którym związane są między innymi
...
wnioski. Przy jej użyciu przeprowadzono wiele badań. 
...
\textit{Support vector machines} to podejście stosujące duży margines między
klasami.
...
do oceny sentymentu. Została opracowana z uwzględnieniem Twittera i korzysta w
związku z tym z pewnych założeń. Skoro nie ma żadnego idealnego słownika ze
słowami oznaczonymi jako pozytywne lub negatywne, to trzeba go mechanicznie
...
zbadanie reakcji społeczeństwa w różnych regionach kraju na planowane
przez rząd zmiany w prawie -- może to na przykład prowadzić do ich wycofania.
...
milionów wpisów dziennie\footnote{www.about.twitter.com/company -- na dzień 16
lipca 2014 r.}.
