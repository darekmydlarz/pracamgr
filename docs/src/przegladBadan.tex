...
tematów, które składają się na tę pracę. Na początku omawiam dziedzinę sieci
społecznych, czym ta nauka się zajmuje i w jakich przypadkach może zostać
zastosowana.
Następnie opisuję analiza sentymentu wypowiedzi i przetwarzanie tekstu pod kątem
tej analizy.
Później skupiam się nad geolokacją, opisem tego co można dzięki niej się
dowiedzieć. Dodatkowo na końcu omawiam serwis społecznościowego Twitter, który
...
Miara określająca liczbę krawędzi wchodzących i 
  wychodzących z wierzchołka \refimg{image:stopien-wierzcholka}
...
Podejście stosujące duży margines między klasami.
