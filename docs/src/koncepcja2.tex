...
\rref{subsection:fastufoldingofcommunities}, który został zaimplementowany w
...
w sposób zaprezentowany w opisie algorytmu \rref{subsubsection:pakandparoubek}.
...
\refimg{image:pak-paroubek-parametry}.
