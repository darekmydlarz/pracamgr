package pl.edu.agh.twitter.entities.tweet;
...
public class TweetDAO {
    ...
    @SuppressWarnings("unchecked")
    public List<Relationship> getUsersRepliesRelations(Collection<User> users) {
        List<Long> usersIds = Lambda.extract(users, on(User.class).getId());
        final String query = "SELECT NEW pl.edu.agh.twitter.entities.Relationship(t.user.id, t.inReplyToUserId, COUNT(t)) " +
                " FROM Tweet t " +
